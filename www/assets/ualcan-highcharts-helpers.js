function createBoxPlot(containerId, showJitter, gene, cancer, dataset, yAxis, data, medianWidth=2.5, enableJitter=true, scatterMarkerRadius=2, plotIterator){
	...
	if(!window.Highcharts || window.Highcharts.version < '7.0.2'){
		enableJitter = false;
		console.log(`Jitter requires highcharts at least version 7.0.2 and version detected was ${windows.Highcharts.version}`)
	}
